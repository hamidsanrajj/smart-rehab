                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            <h4 class="text-white mb-4"><i class="fas fa-plus me-3"></i>Smart Rehab</h4>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Smart rehab</a>, All right reserved.</span>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\smart-rehab\resources\views/include/footer.blade.php ENDPATH**/ ?>