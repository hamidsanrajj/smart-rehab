      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              We are inance, we have been active since 2020 after covid. we have dealt with many cases of repair and maintenance. we are happy to work with our expertise in respective area of work at reasonable cost. once you signed up with us, we will make sure you will come again to us for our services.
            </p>
            <!-- <a href="">
              Read More
            </a> -->
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
              we provide professional home services include repair, maintenance, plumbing, electrical or many. we have experts in respective area of work to resolve the particular issue you are facing. 
            </p>
            <!-- <a href="">
              Read More
            </a> -->
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                we have experts for any kind of maintenance work at very reasonable cost
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                we have experts for any kind of electrical work at very reasonable cost
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                we have experts for any kind of plumbing work at very reasonable cost
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  best work!! these guys have talent i must say
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  good job inance did, they have experts no doubt
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  tremendious work for my plumbing issue 
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  inance done an amazing job, i just ordered inance for my electrical work. The inance agent came to my house and done his work super quick and at very reasonable cost
                </p>
              </div>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\inance\resources\views/include/main.blade.php ENDPATH**/ ?>